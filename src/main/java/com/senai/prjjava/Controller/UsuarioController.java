package com.senai.prjjava.Controller;
...
import com.senai.prjjava.Repository.UsuarioRepository;
...
public class UsuarioController {
    ...
    // http://localhost:8080/api/usuario/2 - nesse exemplo é usadi uma variavel de
    // path (caminho)
    @GetMapping("/{id}")
